...
(defn init []
  ...
  (set-highlight "Cursor" "NONE" (get-color "rosewater"))
  ...
  (set-highlight "Comment" (get-color "mauve") "NONE")
  (set-highlight "String" (get-color "green") "NONE")
  (set-highlight "StringDelimiter" (get-color "green") "NONE")
  (set-highlight "Number" (get-color "peach") "NONE")
  (set-highlight "Boolean" (get-color "peach") "NONE")
  (set-highlight "Float" (get-color "peach") "NONE")
  (set-highlight "Function" (get-color "lavender") "NONE")
  (set-highlight "Identifier" (get-color "lavender") "NONE")
  (set-highlight "vimOption" (get-color "lavender") "NONE")
  (set-highlight "FennelDefine" "NONE" "NONE")
  (set-highlight "FennelMacro" (get-color "lavender") "NONE")
  (set-highlight "FennelLuaFunction" (get-color "lavender") "NONE"))
