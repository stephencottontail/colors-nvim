...
local _2amodule_name_2a = "nvim-colors.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("nvim-colors.aniseed.core"), autoload("nvim-colors.aniseed.compile"), autoload("nvim-colors.aniseed.fennel"), autoload("nvim-colors.aniseed.fs"), autoload("nvim-colors.aniseed.nvim")
