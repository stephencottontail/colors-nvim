...
local _2amodule_name_2a = "nvim-colors.aniseed.fennel"
local _2amodule_2a
do
...
local a, fs, nvim, str = autoload("nvim-colors.aniseed.core"), autoload("nvim-colors.aniseed.fs"), autoload("nvim-colors.aniseed.nvim"), autoload("nvim-colors.aniseed.string")
...
local function impl()
  local compiler = require("nvim-colors.aniseed.deps.fennel")
