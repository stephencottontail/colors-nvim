...
local _2amodule_name_2a = "nvim-colors.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("nvim-colors.aniseed.compile"), autoload("nvim-colors.aniseed.fennel"), autoload("nvim-colors.aniseed.fs"), autoload("nvim-colors.aniseed.nvim")
