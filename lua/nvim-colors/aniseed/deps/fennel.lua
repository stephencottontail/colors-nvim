package.preload["nvim-colors.aniseed.fennel.repl"] = package.preload["nvim-colors.aniseed.fennel.repl"] or function(...)
  local utils = require("nvim-colors.aniseed.fennel.utils")
  local parser = require("nvim-colors.aniseed.fennel.parser")
  local compiler = require("nvim-colors.aniseed.fennel.compiler")
  local specials = require("nvim-colors.aniseed.fennel.specials")
  local view = require("nvim-colors.aniseed.fennel.view")
...
package.preload["nvim-colors.aniseed.fennel.specials"] = package.preload["nvim-colors.aniseed.fennel.specials"] or function(...)
  local utils = require("nvim-colors.aniseed.fennel.utils")
  local view = require("nvim-colors.aniseed.fennel.view")
  local parser = require("nvim-colors.aniseed.fennel.parser")
  local compiler = require("nvim-colors.aniseed.fennel.compiler")
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "nvim-colors.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["nvim-colors.aniseed.fennel.compiler"] = package.preload["nvim-colors.aniseed.fennel.compiler"] or function(...)
  local utils = require("nvim-colors.aniseed.fennel.utils")
  local parser = require("nvim-colors.aniseed.fennel.parser")
  local friend = require("nvim-colors.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["nvim-colors.aniseed.fennel.friend"] = package.preload["nvim-colors.aniseed.fennel.friend"] or function(...)
  local utils = require("nvim-colors.aniseed.fennel.utils")
...
package.preload["nvim-colors.aniseed.fennel.parser"] = package.preload["nvim-colors.aniseed.fennel.parser"] or function(...)
  local utils = require("nvim-colors.aniseed.fennel.utils")
  local friend = require("nvim-colors.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils
package.preload["nvim-colors.aniseed.fennel.view"] = package.preload["nvim-colors.aniseed.fennel.view"] or function(...)
...
package.preload["nvim-colors.aniseed.fennel.utils"] = package.preload["nvim-colors.aniseed.fennel.utils"] or function(...)
  local view = require("nvim-colors.aniseed.fennel.view")
  local version = "1.3.0"
...
utils = require("nvim-colors.aniseed.fennel.utils")
local parser = require("nvim-colors.aniseed.fennel.parser")
local compiler = require("nvim-colors.aniseed.fennel.compiler")
local specials = require("nvim-colors.aniseed.fennel.specials")
local repl = require("nvim-colors.aniseed.fennel.repl")
local view = require("nvim-colors.aniseed.fennel.view")
...
do
  local module_name = "nvim-colors.aniseed.fennel.macros"
  local _
