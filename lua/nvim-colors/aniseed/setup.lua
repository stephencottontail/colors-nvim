...
local _2amodule_name_2a = "nvim-colors.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("nvim-colors.aniseed.core"), autoload("nvim-colors.aniseed.env"), autoload("nvim-colors.aniseed.eval"), autoload("nvim-colors.aniseed.nvim")
