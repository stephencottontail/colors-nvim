...
local _2amodule_name_2a = "nvim-colors.aniseed.compile"
local _2amodule_2a
do
...
local a, fennel, fs, nvim = autoload("nvim-colors.aniseed.core"), autoload("nvim-colors.aniseed.fennel"), autoload("nvim-colors.aniseed.fs"), autoload("nvim-colors.aniseed.nvim")
do end (_2amodule_locals_2a)["a"] = a
_2amodule_locals_2a["fennel"] = fennel
_2amodule_locals_2a["fs"] = fs
_2amodule_locals_2a["nvim"] = nvim
local function wrap_macros(code, opts)
  local macros_module = "nvim-colors.aniseed.macros"
  local filename
  do
